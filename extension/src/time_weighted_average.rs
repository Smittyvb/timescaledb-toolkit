...
mod toolkit_experimental {
    use crate::accessors::toolkit_experimental::*;
    use super::*;
...
#[pg_extern(immutable, parallel_safe, name = "integral", schema = "toolkit_experimental")]
...
#[pg_extern(immutable, parallel_safe, name = "interpolated_integral", schema = "toolkit_experimental")]
